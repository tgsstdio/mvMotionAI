...
int mvLua_SetObstacleParameteri_str(lua_State* luaVM);
int mvLua_GetObstacleParameteri_str(lua_State* luaVM);
...
int mvLua_SetWaypointParameteri_str(lua_State* luaVM);
